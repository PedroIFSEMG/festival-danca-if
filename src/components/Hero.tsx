        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          <div className="lg:hidden flex flex-col items-center text-center order-1 mt-4">
              ...
              >
                ...
                <span className="font-serif italic text-6xl sm:text-8xl block -mt-2 pb-2 font-medium tracking-normal text-[var(--color-festival-text)]">de <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-festival-gold)] to-[var(--color-festival-rose)]">Dança</span></span>
              </motion.h1>
          </div>
