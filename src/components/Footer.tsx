...
export default function Footer() {
  return (
    <footer className="bg-festival-dark text-[var(--color-festival-text)] pt-16 pb-8 border-t border-[var(--color-festival-primary)]/15">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left space-y-5 sm:col-span-2 lg:col-span-1">
            ...
            <div className="font-serif text-xl tracking-[0.15em] font-medium text-[var(--color-festival-primary)] uppercase leading-tight">
              <span className="font-roman text-[var(--color-festival-text)] pr-0.5 select-none">X</span> Festival<br />de Dança
            </div>
            <p className="text-[var(--color-festival-text)]/50 font-light text-sm leading-relaxed max-w-xs">
          ...
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
            ...
            <ul className="space-y-3 text-[var(--color-festival-text)]/55 font-light text-sm">
              {[
          ...
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
            ...
            <ul className="space-y-4 text-[var(--color-festival-text)]/55 font-light text-sm">
          ...
          <div className="flex flex-col items-center sm:items-start">
            <div className="bg-[var(--color-festival-primary)]/[0.06] rounded-2xl p-5 border border-[var(--color-festival-primary)]/15 w-full">
              <p className="text-sm text-[var(--color-festival-text)]/55 mb-4 leading-relaxed text-center sm:text-left">
        ...
        {/* Bottom bar */}
        <div className="border-t border-[var(--color-festival-primary)]/10 pt-6 flex flex-col items-center gap-3 md:flex-row md:justify-between text-xs text-[var(--color-festival-text)]/40">
          <p className="text-center md:text-left">
            © {new Date().getFullYear()} <span className="font-roman text-[var(--color-festival-text)]/60 select-none">X</span> Festival de Dança IF Sudeste MG. Todos os direitos reservados.
          </p>
